...
==============================================================================*/
package com.example.tobinornottobin2.Metadata;
...
public class MetadataExtractor {
     ...
     *
     * @param ssd_mobilenet_v1_1_metadata_1 the name of the associated file
     ...
     */
    public InputStream getAssociatedFile(String ssd_mobilenet_v1_1_metadata_1) {
        assertZipFile();
        return zipFile.getRawInputStream(ssd_mobilenet_v1_1_metadata_1);
    }
     ...
     * @return
     */
    public org.tensorflow.lite.support.metadata.MetadataExtractor.QuantizationParams getInputTensorQuantizationParams(int inputIndex) {
     ...
     * @return
     */
    public org.tensorflow.lite.support.metadata.MetadataExtractor.QuantizationParams getOutputTensorQuantizationParams(int outputIndex) {
