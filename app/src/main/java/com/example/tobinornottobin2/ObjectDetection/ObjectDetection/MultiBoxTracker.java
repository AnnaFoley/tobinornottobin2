...
public class MultiBoxTracker  {
    ...
    public synchronized void trackResults(final List<Detector.Recognition> results, final long timestamp) throws Exception {
    ...
    private void processResults(final List<Detector.Recognition> results) throws Exception {
