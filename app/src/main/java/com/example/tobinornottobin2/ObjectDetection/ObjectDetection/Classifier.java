...
public abstract class Classifier {
    ...
    protected Classifier(int imageSizeX, int imageSizeY, TensorBuffer outputProbabilityBuffer, TensorProcessor probabilityProcessor) {
        this.imageSizeX = imageSizeX;
        this.imageSizeY = imageSizeY;
        this.outputProbabilityBuffer = outputProbabilityBuffer;
        this.probabilityProcessor = probabilityProcessor;
    }

    public Classifier(Activity activity, Device device, int numThreads, int imageSizeX, int imageSizeY, TensorBuffer outputProbabilityBuffer, TensorProcessor probabilityProcessor) {
        this.imageSizeX = imageSizeX;
        this.imageSizeY = imageSizeY;
        this.outputProbabilityBuffer = outputProbabilityBuffer;
        this.probabilityProcessor = probabilityProcessor;
   ...
   public final int imageSizeX;
    ...
    public final TensorBuffer outputProbabilityBuffer;

    /** Processer to apply post processing of the output probability. */
    public final TensorProcessor probabilityProcessor;
